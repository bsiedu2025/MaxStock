...
tickers_in_db = get_distinct_tickers()
            ...
            try:
                ...
                if hist_data.empty:
                    ...
                    with st.spinner(f"Menyimpan data {input_ticker} ke database..."):
                        if insert_stock_price_data(input_ticker, df_to_save):
                            st.cache_data.clear() 
                            ...
                            df_from_db_after_insert = fetch_stock_prices_from_db(input_ticker, hist_data.index.min(), hist_data.index.max())
                            ...
                            st.error("Gagal menyimpan data. Cek kembali log aplikasi Anda.")
            except Exception as e:
